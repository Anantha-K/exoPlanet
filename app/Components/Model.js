...
// const exoplanets = [
//   { name: "Earth", component: Modelx},
//   { name: "Kepler-22b", component: Keplar },
//   { name: "Kepler-1229b", component: Kepler1229b },
//   { name: "Kepler-1544", component: Kepler1544 },
//   { name: "Kepler-442", component: Kepler442 },
// ];
...
//   const [planetValues, setPlanetValues] = useState({selectedPlanet});
...
//       <h1 className="text-white mt-10 flex text-5xl z-10" style={{ fontFamily: "Array,sans-serif" }}>
//         <TypeAnimation
//           key={key}
...
//               <span>Mass:</span>
//               <span className="font-semibold">{planetValues.mass}</span>
//             </span>
//           </div>
...
//               <span className="font-semibold">{planetValues.distance} AU</span>
//             </span>
//           </div>
...
//               <span className="font-semibold">{planetValues.temperature}°C</span>
//             </span>
//           </div>
...
//               <span className="font-semibold">{planetValues.vegetation}%</span>
//             </span>
//           </div>

//           <div className="flex items-center text-white/90">
//             <Waypoints className="w-5 h-5 mr-3" />
//             <span className="flex justify-between w-full">
//               <span>Sun Proximity:</span>
//               <span className="font-semibold">{planetValues.sunProximity}</span>
//             </span>
//           </div>
...
//             <span className="flex justify-between w-full">
//               <span>Size:</span>
//               <span className="font-semibold">{planetValues.size}x Earth</span>
//             </span>
//           </div>
...
//               <span className="font-semibold">{(planetValues.atmosphere * 100).toFixed(0)}%</span>
//             </span>
//           </div>
//         </div>
//       </div>
...
// import React, { useState, useEffect } from "react";
// import { TypeAnimation } from "react-type-animation";
// import { Globe2, Thermometer, Ruler, Navigation, Dna, Trees, Waypoints } from "lucide-react";
// import { Button } from "@/components/ui/button";
// import AI from "./AI";
// import Modelx from "./Modelx";
// import Keplar from "./Kepler";
...
//     setKey((prevKey) => prevKey + 1); // Trigger animation key update
//   };


//   const checkHabitability = async () => {
//     try {
//       const response = await fetch('/api/habitability', {  
//         method: 'POST',
//         headers: {
//           'Content-Type': 'application/json',
//         },
//         body: JSON.stringify(planetValues),  
//       });
...
//     setPlanetValues(prev => ({ ...prev, ...newValues }));
//   };
